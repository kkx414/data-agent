...
from app.repositories.mysql.meta.mappers.column_metric_info_mapper import ColumnMetricMapper
...
class MetaMySQLRepository:
    ...
    async def get_key_columns_info_by_table_id(self, table_id) -> list[ColumnInfo]:
        sql="select * from column_info where table_id = :table_id and role in ('primary', 'foreign_key') "
